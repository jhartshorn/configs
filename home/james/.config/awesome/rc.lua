...
-- Themes define colours, icons, and wallpapers (default, sky, zenburn)
beautiful.init("/usr/share/awesome/themes/default_light/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "w", function () awful.util.spawn("gg") end),
    awful.key({ modkey, "Shift"   }, "w", function () awful.util.spawn("iceweasel") end),
